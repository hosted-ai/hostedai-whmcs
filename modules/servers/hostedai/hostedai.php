...
{   
    ...
    return array(
        ...
        'pricing_policy' => array(
            ...
            'Description' => 'hosted·ai pricing policy applied to the team — sets the rates and currency used for billing.',
        ),
        'resource_policy' => array(
            ...
            'Description' => 'Resource quota policy — the CPU / RAM / GPU / storage limits the team may use.',
        ),
        'service_policy' => array(
            ...
            'Description' => 'Which hosted·ai services the team is allowed to deploy.',
        ),
        'instance_type_policy' => array(
            ...
            'Description' => 'Which instance types the team is allowed to launch.',
        ),
        'image_policy' => array(
            ...
            'Description' => 'Which OS images the team is allowed to use.',
        ),
        'color' => array(
            'FriendlyName' => 'Color',
            'Type' => 'dropdown',
            ...
            'Description' => 'Accent color shown for this team\'s workspace in the hosted·ai UI.',
        ),
        'loginUrl' => array(
            'FriendlyName' => 'Login URL',
            'Type' => 'text',
            'Size' => '255',
            'Description' => 'URL the client-area "Login" button opens (your hosted·ai user panel). Leave blank to use the default panel URL.',
        ),
        'suspentionDays' => array(
            'FriendlyName' => 'No. of Suspension Days (monthly mode)',
            'Type' => 'text',
            'Size' => '25',
            'Description' => 'Monthly billing only. Days after an unpaid invoice before the service is auto-suspended. Leave blank to disable. Ignored in prepaid mode (prepaid suspends on wallet balance).',
        ),
        'termminationDays' => array(
            'FriendlyName' => 'No. of Termination Days (monthly mode)',
            'Type' => 'text',
            'Size' => '25',
            'Description' => 'Monthly billing only. Days after an unpaid invoice before the service — and its hosted·ai team — is auto-terminated (deleted). Leave blank to disable. Ignored in prepaid mode.',
        ),
        'billing_mode' => array(
